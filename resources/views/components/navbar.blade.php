...
@php
    ...
    $dataCenterActive = $active === 'data-center';
    $eventActive = $active === 'seminar' || $active === 'wisudaan' || $active === 'event';
    ...
    <nav class="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div class="hidden items-center gap-1 lg:flex" data-dropdown-group="desktop-nav">
            ...
            <details class="group relative">
                ...
                <div class="pointer-events-none absolute right-0 top-full mt-2 w-44 overflow-hidden rounded-xl border border-white/20 bg-[#B53737] text-white opacity-0 shadow-2xl transition duration-200 ease-out group-open:pointer-events-auto group-open:opacity-100">
                    ...
                    <a href="{{ route('about-us-struktur') }}" class="block px-4 py-2.5 text-sm transition hover:bg-white/10" data-close-dropdown>Struktur</a>
                    <a href="{{ route('about-us-ikati') }}" class="block px-4 py-2.5 text-sm transition hover:bg-white/10" data-close-dropdown>IKATI</a>
                </div>
            </details>

            <a href="{{ route('data-center') }}" class="{{ $dataCenterActive ? 'rounded-lg bg-white/10 text-white px-4 py-2 text-[18px] font-semibold leading-none' : 'rounded-lg px-4 py-2 text-[18px] font-semibold leading-none text-white/95 transition hover:bg-white/10 hover:text-white' }}">Data Center</a>

            <details class="group relative">
                <summary class="{{ $cornerActive ? 'flex cursor-pointer items-center gap-2 rounded-lg bg-white/10 px-4 py-2 text-[18px] font-semibold leading-none text-white' : 'flex cursor-pointer items-center gap-2 rounded-lg px-4 py-2 text-[18px] font-semibold leading-none text-white/95 transition hover:bg-white/10 hover:text-white' }}">
                    Corner
                    <svg class="h-4 w-4 transition duration-200 group-open:rotate-180" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.51a.75.75 0 01-1.08 0L5.21 8.27a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
                    </svg>
                ...
                <div class="pointer-events-none absolute right-0 top-full mt-2 w-44 overflow-hidden rounded-xl border border-white/20 bg-[#B53737] text-white opacity-0 shadow-2xl transition duration-200 ease-out group-open:pointer-events-auto group-open:opacity-100">
                    <a href="{{ route('corner') }}" class="block px-4 py-2.5 text-sm transition hover:bg-white/10" data-close-dropdown>Berita</a>
                    <a href="{{ route('corner-apresiasi') }}" class="block px-4 py-2.5 text-sm transition hover:bg-white/10" data-close-dropdown>Apresiasi</a>
                </div>
            </details>
        ...
        <details class="group relative lg:hidden">
            ...
            <div class="absolute right-0 top-full mt-2 w-64 rounded-xl border border-white/20 bg-[#B53737]/95 p-4 shadow-2xl backdrop-blur-sm" data-dropdown-group="mobile-nav">
                ...
                <details class="group mt-2">
                    ...
                    <div class="grid grid-rows-[0fr] transition-all duration-200 group-open:grid-rows-[1fr]">
                        <div class="overflow-hidden">
                            ...
                            <a href="{{ route('about-us-struktur') }}" class="block rounded-lg px-3 py-2 text-sm text-white/80 transition hover:bg-white/10" data-close-dropdown>Struktur</a>
                ...
                <a href="{{ route('data-center') }}" class="{{ $dataCenterActive ? 'mt-1 block rounded-lg bg-white/10 px-3 py-2 text-sm font-semibold text-white' : 'mt-1 block rounded-lg px-3 py-2 text-sm text-white/90 transition hover:bg-white/10' }}">Data Center</a>

                <details class="group mt-2">
                    <summary class="{{ $cornerActive ? 'flex cursor-pointer items-center justify-between rounded-lg bg-white/10 px-3 py-2 text-sm font-semibold text-white' : 'flex cursor-pointer items-center justify-between rounded-lg px-3 py-2 text-sm text-white/90 transition hover:bg-white/10' }}">
                        Corner
                        <svg class="h-4 w-4 transition duration-200 group-open:rotate-180" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.51a.75.75 0 01-1.08 0L5.21 8.27a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
                        </svg>
                    ...
                    <div class="grid grid-rows-[0fr] transition-all duration-200 group-open:grid-rows-[1fr]">
                        <div class="overflow-hidden">
                            <a href="{{ route('corner') }}" class="block rounded-lg px-3 py-2 text-sm text-white/80 transition hover:bg-white/10" data-close-dropdown>Berita</a>
                            <a href="{{ route('corner-apresiasi') }}" class="block rounded-lg px-3 py-2 text-sm text-white/80 transition hover:bg-white/10" data-close-dropdown>Apresiasi</a>
                        </div>
                    </div>
                </details>
