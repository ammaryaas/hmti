<x-layouts.app
    ...
    active-nav="about"
    description="IKATI (Ikatan Alumni Teknik Industri Unsoed) hadir untuk menghubungkan kembali, memperkuat jaringan, dan membuka peluang kolaborasi antar alumni Teknik Industri Universitas Jenderal Soedirman."
>
    <main>
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="space-y-6 text-slate-800">
                    <div>
                        ...
                        <a href="https://www.instagram.com/ikati_unsoed?igsh=ZHF1a2R5eTl3bW1s" target="_blank">
